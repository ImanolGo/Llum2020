...
class LedGroup{
    ...
    public:
        ...
        const ofRectangle & getBoundingBox2D() const {return m_boundingBox2D;}
    
        void setBoundingBox2D(const ofRectangle & box) {m_boundingBox2D = box;}

        void setBoundingBox3D(const ofRectangle & box) {m_boundingBox3D = box;}
    ...
    protected:
        ...
        ofRectangle        m_boundingBox3D,m_boundingBox2D;
        float              m_offset;
